"""SOLO 2 HILOS, PERO CADA UNO SUMA LA FILA ENVIADA Y LA SIGUIENTE, OPTIMIZANDO EL PROCESO"""
...
def sum_rows(row_idx):
    ...
    """EL HILO SUMA LA FILA ENVIADA Y LA SIGUIENTE, OPTIMIZANDO EL PROCESO"""
