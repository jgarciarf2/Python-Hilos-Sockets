"""
MODIFICACIÓN 1 - Cliente
========================
El cliente NO cambia con respecto al taller base.
El cambio Barrier → Event es completamente interno al servidor.

Se mantiene igual: envía pedidos aleatorios vía socket TCP.
"""
